  ...
  <style>
    *{
    ...
    .bgcolor {
      ...
      background: linear-gradient(180deg, #6D639C 0%, #3B3652 100%);
    }
...
<body>
  ...
  <main class="d-flex">
    ...
    <div class="d-flex flex-column flex-shrink-0 bgcolor" style="width: 5rem;">
      <a href="?page=home" class="d-block p-3_1 link-body-emphasis text-decoration-none" title="Etaure" data-bs-toggle="tooltip" data-bs-placement="right">
        <img class="bi pe-none" src="img/logo-etaure-branco.svg" alt="Logo Etaure" width="55" height="55">
        <span class="visually-hidden">Logo Etaure</span>
      </a>
      <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
        <li class="nav-item">
          <a href="?page=home" class="nav-link py-3 border-bottom rounded-0" aria-current="page" title="Início" data-bs-toggle="tooltip" data-bs-placement="right">
        ...
        <li>
          <a href="?page=colaboradores" class="nav-link py-3 border-bottom rounded-0" title="Colaboradores" data-bs-toggle="tooltip" data-bs-placement="right">
        ...
        <li>
          <a href="?page=tela_ponto" class="nav-link py-3 border-bottom rounded-0" title="Ponto" data-bs-toggle="tooltip" data-bs-placement="right">
    ...
    <div class="b-example-divider b-example-vr" style="width: 0.1px;"></div>
    
    <div class="caixa" style=" overflow:  scroll; width: 100vw;">
