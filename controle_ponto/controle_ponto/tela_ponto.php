          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-body">
                ...
                <a href="?page=adc_ponto" class="btn btn-primary efeito">Adicionar Registro</a>
              </div>
            </div>
          </div>
          <?php
            ...
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="?page=lista_pontos_funcionarios" class="btn btn-primary efeito">Listar Registros</a>
                </div>
              </div>
            </div>
          <?php
            ...
            <div class="col-sm-6">
              <div class="card" style="height: 100%;">
                <div class="card-body">
                  ...
                  <a href="?page=listar_pontos" class="btn btn-primary efeito" style="margin-top: 5%;">Gerenciar Pontos de funcionários</a>
                </div>
              </div>
            </div>
          <?php } ?>
